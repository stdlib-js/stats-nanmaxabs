...
interface Unary {
	...
	*/
	...
	/**
	* Computes the maximum absolute value along one or more ndarray dimensions, ignoring `NaN` values, and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
